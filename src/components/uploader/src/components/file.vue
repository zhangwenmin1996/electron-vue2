    ...
    <slot
      ...
      <div class="uploader-file-info">
        ...
        <div class="uploader-file-status">
          ...
          <span style="display:flex;justify-content: space-around;" v-show="status === 'uploading'">
...
<script>
  import Uploader from '../../simple-uploader/src/uploader.js'
  ...
  export default {
    ...
    computed: {
      ...
      formatedAverageSpeed () {
        let num = this.file.files.length
    ...
    methods: {
      ...
      // _fileError (rootFile, file, message) { // 正常的
      //   this._fileProgress()
      //   this.processResponse(message)
      //   this.error = true
